...
HD_PWD='C:/Users/binup/HobbyProjects/ActiveProjects/Git_repos/microbuzz/projects/arty-z7-i2s/PL/vivado_i2s_tx/vivado_i2s_tx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2s_tx_top.vds -m64 -tempDir C:/V_temp -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2s_tx_top.tcl
