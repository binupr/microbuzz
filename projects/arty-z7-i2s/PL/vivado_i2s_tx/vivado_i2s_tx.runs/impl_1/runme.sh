...
HD_PWD='C:/Users/binup/HobbyProjects/ActiveProjects/Git_repos/microbuzz/projects/arty-z7-i2s/PL/vivado_i2s_tx/vivado_i2s_tx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2s_tx_top.vdi -applog -m64 -tempDir C:/V_temp -product Vivado -messageDb vivado.pb -mode batch -source i2s_tx_top.tcl -notrace
