...
REM
REM Generated by Vivado on Fri Apr 07 19:15:10 +1000 2023
...
echo "xvlog --incr --relax -L uvm -prj tb_counter_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_counter_vlog.prj -log xvlog.log
